...
(defun my-remote-colorize ()
  (when (file-remote-p default-directory)
    ...
    (face-remap-add-relative 'mode-line-inactive (list :background "DarkOrchid4"))))
(add-hook 'find-file-hook 'my-remote-colorize)
(add-hook 'dired-mode-hook 'my-remote-colorize)
